...
//    questionModel.findOne({body:question,subject:subject}).then((ques)=>{
//     if(!ques){
//       return res.json({
//        message:"that like is not there"
//       });
//     }
//     else{
//       return res.json({
...
// questionModel.find({_id:{$in:req.body.queids}}).then((ques)=>{
//   if(ques.length< req.body.queids){

//   }
//   else{
//     for(var q in req.body.queids){
